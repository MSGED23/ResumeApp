  ...
  const certifications: Certification[] = [
    {
      ...
      issuer: "Microsoft",
      image: "https://images.unsplash.com/photo-1607252650355-f7fd0460ccdb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&h=300&q=80",
      date: "2020"
    },
    {
    ...
    },
    {
      ...
      issuer: "Google",
      image: "https://images.unsplash.com/photo-1579389083078-4e7018379f7e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&h=300&q=80",
      date: "2022"
    }
  ];
  ...
  return (
    <div className="font-sans bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-500 overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute top-0 left-0 w-72 h-72 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-2000"></div>
        <div className="absolute top-0 right-0 w-72 h-72 bg-yellow-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-4000"></div>
        <div className="absolute -bottom-8 left-20 w-72 h-72 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob"></div>
      </div>
      ...
      <section id="home" className="min-h-screen flex items-center pt-20 pb-16 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20 relative overflow-hidden">
        ...
        <motion.div 
          ...
          className="absolute top-20 left-10 w-10 h-10 bg-pink-500 rounded-lg opacity-20"
        ></motion.div>
        <motion.div 
          animate={{...floatingAnimation, transition: { duration: 4, repeat: Infinity, ease: "easeInOut" }}}
          className="absolute top-1/3 right-20 w-16 h-16 bg-yellow-500 rounded-full opacity-20"
        ></motion.div>
        <motion.div 
          animate={{...floatingAnimation, transition: { duration: 5, repeat: Infinity, ease: "easeInOut" }}}
          className="absolute bottom-20 left-1/4 w-12 h-12 bg-blue-500 rounded-lg opacity-20"
        ></motion.div>
          ...
          >
            <div className="relative">
              <motion.div 
                ...
                className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-2xl max-w-md w-full border-2 border-white/20 relative overflow-hidden"
              >
                {/* Decorative elements */}
                <div className="absolute -top-4 -right-4 w-24 h-24 bg-pink-500 rounded-full opacity-10"></div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-8 rounded-3xl shadow-xl border border-white/50 dark:border-gray-700/50 backdrop-blur-sm"
            >
      ...
      {/* Skills Section */}
      <section id="skills" className="py-20 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
        {/* Animated background elements */}
        <motion.div 
          animate={{
            rotate: 360,
          ...
          className="absolute -top-48 -right-48 w-96 h-96 bg-pink-500 rounded-full opacity-10"
        ></motion.div>
        ...
        <motion.div 
          ...
          className="absolute -bottom-48 -left-48 w-96 h-96 bg-blue-500 rounded-full opacity-10"
        ></motion.div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {skillCategories.map((category, index) => (
              ...
              >
                {/* Background gradient */}
                <div className={`absolute inset-0 opacity-5 group-hover:opacity-10 transition-opacity duration-500 ${category.color}`}></div>
                
                <motion.div 
                  whileHover={{ rotate: 10, scale: 1.1 }}
                  className={`p-3 rounded-2xl ${category.color} text-white mb-6 inline-flex shadow-lg`}
                >
                  {category.icon}
                </motion.div>
                ...
                <motion.div 
                  ...
                  className={`absolute bottom-0 left-0 h-1 ${category.color} rounded-full`}
                ></motion.div>
              </motion.div>
            ))}
          </div>
      ...
      {/* Projects Section */}
      <section id="projects" className="py-20 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
        {/* Animated background elements */}
        <motion.div 
          animate={{
            y: [0, -20, 0],
              ...
              >
                <div className="h-48 overflow-hidden relative">
                  ...
                  <motion.img 
                    ...
                    onError={() => handleImageError(`project-${index}`)}
                  />
      ...
      <section id="certifications" className="py-20 bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
        {/* Animated background elements */}
        <motion.div 
          animate={{
            scale: [1, 1.1, 1],
              ...
              >
                <div className="h-40 overflow-hidden">
                  <motion.img 
                    ...
                    alt={cert.title}
                    className="w-full h-full object-cover transition-transform duration-500"
                    onError={() => handleImageError(`cert-${index}`)}
                  />
                </div>
                <div className="p-4">
